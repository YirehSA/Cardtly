...
export const TEMPLATE_CONTROLS: Record<TemplateId, string[]> = {
  ...
  modern: ['photoSize', 'logo', 'nameType', 'titleType', 'companyType', 'bioType', 'bodySize', 'textPosition', 'socialIcons'],
  bold: ['photoSize', 'profileBorder', 'logo', 'nameType', 'titleType', 'companyType', 'bioType', 'bodySize', 'textPosition', 'socialIcons'],
  minimal: ['photoSize', 'profileBorder', 'logo', 'nameType', 'titleType', 'companyType', 'bioType', 'bodySize', 'socialIcons'],
  executive: ['photoZoom', 'logo', 'nameType', 'titleType', 'companyType', 'bioType', 'bodySize', 'socialIcons'],
  creative: ['photoSize', 'logo', 'nameType', 'titleType', 'companyType', 'bioType', 'bodySize', 'socialIcons'],
  wave: ['photoSize', 'logo', 'solidBackground', 'nameType', 'titleType', 'companyType', 'bioType', 'bodySize', 'textPosition', 'socialIcons'],
  split: ['photoSize', 'profileBorder', 'logo', 'nameType', 'titleType', 'companyType', 'bioType', 'bodySize', 'socialIcons'],
  ...
  neon: ['photoSize', 'profileBorder', 'logo', 'nameType', 'titleType', 'companyType', 'bioType', 'bodySize', 'textPosition', 'socialIcons'],
  studio: ['photoSize', 'profileBorder', 'logo', 'nameType', 'titleType', 'companyType', 'bioType', 'bodySize', 'socialIcons'],
  frost: ['photoSize', 'logo', 'nameType', 'titleType', 'companyType', 'bioType', 'bodySize', 'socialIcons'],
  editorial: ['photoSize', 'profileBorder', 'logo', 'nameType', 'titleType', 'companyType', 'bioType', 'bodySize'],
  showroom: ['photoSize', 'logo', 'nameType', 'titleType', 'companyType', 'bioType', 'bodySize', 'socialIcons'],
}
