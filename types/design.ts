...
export const TEMPLATES: TemplateConfig[] = [
  ...
  { id: 'minimal',   name: 'Minimal',   description: 'Vibrant icons, premium dark hero',    proOnly: true,  defaultBgMode: 'dark',  previewGradient: 'from-slate-950 to-blue-950' },
...
export function getBgColors(mode: BgMode, templateId: TemplateId): {
  ...
  const dark: Record<TemplateId, ReturnType<typeof getBgColors>> = {
    ...
    minimal:   { page: '#0a0e1a', card: '#10172a', surface: '#1a2236', text: '#ffffff', subtext: 'rgba(255,255,255,0.55)', border: 'rgba(255,255,255,0.08)' },
