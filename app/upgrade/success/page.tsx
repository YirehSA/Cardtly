...
export default function UpgradeSuccessPage({
  ...
  const isYearly = searchParams.plan === 'yearly'
      ...
      <div className="max-w-md w-full text-center">
        ...
        <div className="relative">
          ...
          <h1 className="text-4xl font-black tracking-tight mb-3 text-white">
            You're now <span style={gradText}>Pro!</span>
          </h1>

          <p className="text-lg mb-2" style={{ color: 'rgba(255,255,255,0.6)' }}>
            Welcome to the full Cardtly experience.
          </p>
          <p className="text-sm mb-8" style={{ color: 'rgba(255,255,255,0.35)' }}>
            {isYearly
              ? 'Your Pro plan is active for the next 12 months.'
              : 'Your Pro plan renews monthly. Cancel anytime from Settings.'}
          </p>
          ...
          <div className="rounded-2xl p-6 mb-8 text-left"
            ...
            <div className="space-y-2.5">
              {[
                ...
                <p key={item} className="text-sm" style={{ color: 'rgba(255,255,255,0.65)' }}>
                  ✓ {item}
                </p>
              ))}
            </div>
